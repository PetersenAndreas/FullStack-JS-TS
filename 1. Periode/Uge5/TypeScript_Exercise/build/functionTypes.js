"use strict";
//2b
let firstFunc = function (string1, string2, string3) {
    return [string1, string2, string3];
};
//console.log(firstFunc("gutenmorgen","dav","næ"));
//2c
let secondFunc = function (string1, string2, string3) {
...
f2(secondFunc);
//2f
function thisShouldMakeAnErr(noString1, noString2, noString3) {
